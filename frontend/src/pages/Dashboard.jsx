    ...
    <Layout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-card-light dark:bg-card-dark rounded-xl p-6 border border-border-light dark:border-border-dark">
          <p className="text-gray-600 dark:text-gray-400 mb-2">Tổng số nhân viên</p>
          <p className="text-4xl font-bold text-text-light dark:text-text-dark mb-3">
            {stats.totalEmployees}
          </p>
          <div className="flex items-center text-green-500">
            <span className="material-symbols-outlined text-sm">trending_up</span>
            <span className="text-sm ml-1">Dữ liệu từ hệ thống</span>
          </div>
        </div>

        <div className="bg-card-light dark:bg-card-dark rounded-xl p-6 border border-border-light dark:border-border-dark">
          <p className="text-gray-600 dark:text-gray-400 mb-2">Đánh giá đã hoàn thành</p>
          <p className="text-4xl font-bold text-text-light dark:text-text-dark mb-3">
            {stats.completedAssessments} / {stats.totalEmployees}
          </p>
          <div className="flex items-center text-green-500">
            <span className="material-symbols-outlined text-sm">trending_up</span>
            <span className="text-sm ml-1">{stats.completionRate}% hoàn thành</span>
          </div>
        </div>
      </div>

      {/* Chart */}
      <div className="bg-card-light dark:bg-card-dark rounded-xl p-6 border border-border-light dark:border-border-dark mb-8">
        <div className="mb-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            to="/employees"
            className="flex items-center gap-4 p-4 bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark hover:shadow-lg transition-shadow"
          >
            <div className="w-12 h-12 rounded-lg bg-primary/20 flex items-center justify-center">
              <span className="material-symbols-outlined text-primary">group</span>
            </div>
            <div>
              <p className="font-semibold text-text-light dark:text-text-dark">Quản lý nhân viên</p>
          ...
          >
            ...
            <div>
              <p className="font-semibold text-text-light dark:text-text-dark">Tạo đánh giá mới</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Bắt đầu phiên đánh giá mới</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="font-semibold text-text-light dark:text-text-dark">Xem báo cáo chi tiết</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Phân tích dữ liệu chuyên sâu</p>
            </div>
          </Link>
        </div>
      </div>
